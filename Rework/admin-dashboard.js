            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    ${submission.status === 'pending' ? `
                        <button class="btn btn-sm btn-success" onclick="updateSubmissionStatus(${submission.id}, 'approved')">
                            <i class="fas fa-check"></i> Approve
                        </button>
                        <button class="btn btn-sm btn-danger" onclick="updateSubmissionStatus(${submission.id}, 'rejected')">
