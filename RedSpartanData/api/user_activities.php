...
try {
    ...
    $formattedActivities = array_map(function($activity) {
        ...
        $actionIcons = [
            ...
            'password_reset_requested' => 'fa-key',
            'password_reset_approved' => 'fa-key',
        ...
        $actionColors = [
            ...
            'password_reset_approved' => '#10b981',
        ...
        // Keep timestamp in UTC format for JavaScript to handle timezone conversion
        // JavaScript will convert to Philippines timezone on display
        $createdAt = $activity['created_at'];
        
        // If the timestamp doesn't have timezone info, assume it's UTC from database
        try {
            $dateTime = new DateTime($createdAt, new DateTimeZone('UTC'));
            // Return in ISO 8601 format with UTC timezone indicator for proper JavaScript parsing
