...
try {
    ...
    // Add assigned_by user information
    $selectFields[] = 'u.name as assigned_by_name';
    ...
    foreach ($tasks as $task) {
        ...
        $formattedTasks[] = [
            ...
            'status' => $taskStatus,
            'assigned_by' => isset($task['assigned_by_name']) && !empty($task['assigned_by_name']) ? $task['assigned_by_name'] : 'Admin',
            'assigned_by_id' => isset($task['assigned_by']) ? (int)$task['assigned_by'] : null,
